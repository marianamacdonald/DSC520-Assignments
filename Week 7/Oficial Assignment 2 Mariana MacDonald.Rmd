...
```
 This tells us how much of variability in one variable is shared by the other. Time TV shared 78% of the variability in time reading. This leaves the other 22% to be accounted by other variables.
